...
- Generating another statisticcal model using a different method on this analysis is a good idea. On the other hand, the casual inference can be discussed through propensity score matching in this study since the data is observational study instead of experimental study. Using this approachm, the causal inference between the essential factors and the level of heart attack can be determined. 
